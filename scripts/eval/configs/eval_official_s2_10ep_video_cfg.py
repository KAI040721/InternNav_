"""
评估配置文件 - 官方 InternVLA-N1-System2 模型（10集+视频保存）
在 GPU 5 上运行
"""
...
eval_cfg = EvalCfg(
    ...
    eval_settings={
        ...
        "output_path": "./logs/habitat/eval_official_s2_10ep_video",  # output directory for logs/results
        "save_video": True,  # whether to save videos
        "epoch": 0,  # epoch number for logging
        "max_steps_per_episode": 500,  # maximum steps per episode
        "num_episodes": 10,  # limit to 10 episodes
