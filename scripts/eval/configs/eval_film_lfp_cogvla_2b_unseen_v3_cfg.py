"""
评估配置文件 - FiLM-ViT + LFP CogVLA 2B 模型 v3 (7-bug-fix)
...
eval_cfg = EvalCfg(
    agent=AgentCfg(
        ...
        model_settings={
            "mode": "system2",
            "model_path": "checkpoints/FiLM-ViT-LFP-CogVLA-2B-R2XR50-v3",
            ...
            "compressor_checkpoint": "checkpoints/FiLM-ViT-LFP-CogVLA-2B-R2XR50-v3/compressor_film.safetensors",
            "compressor_n_queries": 64,
            "compressor_n_film_layers": 24,
            "compressor_share_film": False,
            # LFP Router 配置
            "use_lfp": True,
            "lfp_checkpoint": "checkpoints/FiLM-ViT-LFP-CogVLA-2B-R2XR50-v3/lfp_router.safetensors",
    ...
    eval_settings={
        "output_path": "./logs/habitat/eval_film_lfp_cogvla_2b_unseen_v3",
        "save_video": False,
        "epoch": 0,
