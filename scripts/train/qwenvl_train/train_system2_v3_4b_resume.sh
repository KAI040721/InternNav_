...
# 绕过 torch.load 安全检查（PyTorch < 2.6）
export TRANSFORMERS_TORCH_LOAD_IS_SAFE=1
...
run_name="InternVLA_N1_System2_4B_v3_resume_1500"
...
torchrun --nnodes=1 --nproc_per_node=${NUM_GPUS} \
    ...
    --run_name ${run_name} \
    --report_to wandb \
    --resume_from_checkpoint /data/houdekai/InternNav_/checkpoints/InternVLA-N1-System2-Qwen3-4B-AllLoRA-r32-v3/checkpoint-1500
